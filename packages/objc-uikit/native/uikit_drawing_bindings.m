...
_ListenerTrampoline _znu25d_wrapListenerBlock_xtuoz7(_ListenerTrampoline block) NS_RETURNS_RETAINED {
  return ^void(id arg0) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _znu25d_wrapBlockingBlock_xtuoz7(
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _znu25d_wrapListenerBlock_18v1jvf(_ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _znu25d_wrapBlockingBlock_18v1jvf(
...
__attribute__((visibility("default"))) __attribute__((used))
void  _znu25d_protocolTrampoline_18v1jvf(id target, void * sel, id arg1) {
  return ((_ProtocolTrampoline)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel, arg1);
}

typedef void  (^_ListenerTrampoline_2)(void * arg0, id arg1, id arg2, BOOL arg3);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _znu25d_wrapListenerBlock_8acz2h(_ListenerTrampoline_2 block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline_2)(void * waiter, void * arg0, id arg1, id arg2, BOOL arg3);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _znu25d_wrapBlockingBlock_8acz2h(
...
typedef void  (^_ProtocolTrampoline_1)(void * sel, id arg1, id arg2, BOOL arg3);
__attribute__((visibility("default"))) __attribute__((used))
void  _znu25d_protocolTrampoline_8acz2h(id target, void * sel, id arg1, id arg2, BOOL arg3) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_3 _znu25d_wrapListenerBlock_fjrv01(_ListenerTrampoline_3 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_3 _znu25d_wrapBlockingBlock_fjrv01(
...
typedef void  (^_ProtocolTrampoline_2)(void * sel, id arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
void  _znu25d_protocolTrampoline_fjrv01(id target, void * sel, id arg1, id arg2) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_4 _znu25d_wrapListenerBlock_1tz5yf(_ListenerTrampoline_4 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_4 _znu25d_wrapBlockingBlock_1tz5yf(
...
__attribute__((visibility("default"))) __attribute__((used))
void  _znu25d_protocolTrampoline_1tz5yf(id target, void * sel, id arg1, id arg2, id arg3) {
