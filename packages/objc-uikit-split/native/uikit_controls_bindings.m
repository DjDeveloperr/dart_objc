...
typedef void  (^_ListenerTrampoline)(id arg0, id arg1, struct objc_selector * arg2, unsigned long arg3, BOOL * arg4);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _v7p84f_wrapListenerBlock_dxmvft(_ListenerTrampoline block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline)(void * waiter, id arg0, id arg1, struct objc_selector * arg2, unsigned long arg3, BOOL * arg4);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _v7p84f_wrapBlockingBlock_dxmvft(
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _v7p84f_wrapListenerBlock_xtuoz7(_ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
  return ^void(id arg0) {
    objc_retainBlock(block);
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _v7p84f_wrapBlockingBlock_xtuoz7(
