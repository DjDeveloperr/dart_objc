...
typedef void  (^_ListenerTrampoline)(id arg0, id arg1, struct objc_selector * arg2, UIControlEvents arg3, BOOL * arg4);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _mabzmp_wrapListenerBlock_1cxqo1i(_ListenerTrampoline block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline)(void * waiter, id arg0, id arg1, struct objc_selector * arg2, UIControlEvents arg3, BOOL * arg4);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _mabzmp_wrapBlockingBlock_1cxqo1i(
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _mabzmp_wrapListenerBlock_18v1jvf(_ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _mabzmp_wrapBlockingBlock_18v1jvf(
...
typedef void  (^_ListenerTrampoline_2)(void * arg0, id arg1, struct CGPoint arg2, struct CGPoint * arg3);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _mabzmp_wrapListenerBlock_1y0a88x(_ListenerTrampoline_2 block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline_2)(void * waiter, void * arg0, id arg1, struct CGPoint arg2, struct CGPoint * arg3);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _mabzmp_wrapBlockingBlock_1y0a88x(
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_3 _mabzmp_wrapListenerBlock_fjrv01(_ListenerTrampoline_3 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_3 _mabzmp_wrapBlockingBlock_fjrv01(
...
typedef void  (^_ListenerTrampoline_4)(void * arg0, id arg1, id arg2, double arg3);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_4 _mabzmp_wrapListenerBlock_gxqm8e(_ListenerTrampoline_4 block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline_4)(void * waiter, void * arg0, id arg1, id arg2, double arg3);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_4 _mabzmp_wrapBlockingBlock_gxqm8e(
...
typedef void  (^_ListenerTrampoline_5)(void * arg0, id arg1, BOOL arg2);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_5 _mabzmp_wrapListenerBlock_zzthnb(_ListenerTrampoline_5 block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline_5)(void * waiter, void * arg0, id arg1, BOOL arg2);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_5 _mabzmp_wrapBlockingBlock_zzthnb(
